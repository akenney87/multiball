"""Test box score fix for Issue #5."""
import sys
import os
...
print("Running test game to validate box score fix...")
game_result = game_sim.simulate_game(seed=601)

# Save full output to file
output_path = "output/boxscore_fix_test.txt"
...
# Extract and display box score section
...
if box_score_start:
    print("\n" + "="*80)
    print("BOX SCORE PREVIEW:")
    print("="*80)
    for line in lines[box_score_start:box_score_start+50]:
        print(line)
