"""
Generate final validation games after patience fix for comprehensive review.
"""
...
print(f"Generating final validation games: {team1['name']} vs {team2['name']}")
...
# Generate 5 games with seeds 9000-9004 (final validation with patience fix)
for i in range(5):
    seed = 9000 + i
    random.seed(seed)

    print(f"Game {i+1}/5 (seed {seed})...", end=" ", flush=True)
    ...
    # Save play-by-play
    output_path = f'output/final_validation_{i+1}.txt'
...
print()
print("=" * 80)
print("All 5 final validation games generated!")
print("=" * 80)
print()
print("Files saved:")
for i in range(5):
    print(f"  - output/final_validation_{i+1}.txt")
